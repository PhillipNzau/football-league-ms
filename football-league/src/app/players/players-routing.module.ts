...
const routes: Routes = [
  {
    path: '', component: PlayersComponent, children: [
      ...
      {
        path: 'players-edit',
        loadChildren: () => import('./players-edit/players-edit.module').then(m => m.PlayersEditModule)
      },
      {
        path: 'players-add',
        loadChildren: () => import('./players-add/players-add.module').then(m => m.PlayersAddModule)
      }
    ]
  },
];
